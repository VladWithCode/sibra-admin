...
function PersonalDataSection({ customer }) {
  ...
  return (
    ...
    >
      ...
      <Row>
        <Detail title="Número Telefónico" value={customer.phoneNumber} />
      </Row>
      <Row>
        <Detail
      ...
      {seeMore ? (
        <>
          ...
          <Row>
            <Detail title="Estado Civil" value={customer.maritalState} />
          </Row>
          <Row>
            <Detail title="Lugar de nacimiento" value={customer.pob} />
          </Row>
          <Row>
            <Detail title="Fecha de nacimiento" value={customer.dob} />
          </Row>
        </>
      ) : null}
    </Section>
